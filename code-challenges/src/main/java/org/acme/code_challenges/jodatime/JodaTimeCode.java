...
public class JodaTimeCode 
{
    ...
    {        
        ...
        System.out.println("Formatted our org.joda.timeLocalDateTime to dd/MM/yyyy HH:mm:ss -> " + localDateTime.toString(formatter));
		...
		System.out.println("Checking if our future org.joda.time.LocalDateTime is after our previous LocalDateTime-> " + futureDate.isAfter(localDateTime));
