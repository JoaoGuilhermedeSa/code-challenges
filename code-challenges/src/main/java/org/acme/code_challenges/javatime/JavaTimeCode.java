...
public class JavaTimeCode {
	public void runJavaTime() {
        ...
        System.out.println("Formatted our org.joda.timeLocalDateTime to dd/MM/yyyy HH:mm:ss -> " + localDateTime.format(formatter));
		...
		System.out.println("Checking if our future java.time.LocalDateTime is after our previous LocalDateTime-> " + futureDate.isAfter(localDateTime));
